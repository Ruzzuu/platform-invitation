...
export default function InvitationPage() {
  ...
  if (!data) return <FullPageMessage><div><h1 className="font-serif text-3xl">Undangan tidak ditemukan</h1><p className="mt-3 text-white/60">Tautan mungkin salah atau undangan belum dipublikasikan.</p><Link to="/" className="mt-6 inline-block text-pink-300 underline">Kembali ke Lembaranbaru.com</Link></div></FullPageMessage>
