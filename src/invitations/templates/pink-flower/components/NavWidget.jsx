      ...
      <motion.button
        ...
        className={`w-11 h-11 rounded-full flex items-center justify-center
                    ...
                    ${isActive
                      ...
                      : 'bg-cream text-warm-gray border-blush/20'
                    }`}
    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className="bg-white/95 backdrop-blur-md border border-blush/20 rounded-full py-4 px-5
            ...
            >
              ...
              <motion.button
                ...
                onClick={() => setOpen(false)}
                className="w-9 h-9 rounded-full bg-cream border border-blush/20
